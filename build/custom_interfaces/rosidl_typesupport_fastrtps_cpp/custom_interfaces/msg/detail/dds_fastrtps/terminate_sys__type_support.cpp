...
#include "custom_interfaces/msg/detail/terminate_sys__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces::msg::TerminateSys;
    is_plain =
      (
      offsetof(DataType, a) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const custom_interfaces::msg::TerminateSys *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interfaces::msg::TerminateSys *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TerminateSys__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const custom_interfaces::msg::TerminateSys *>(
...
static size_t _TerminateSys__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TerminateSys(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TerminateSys__callbacks = {
...
static rosidl_message_type_support_t _TerminateSys__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TerminateSys__callbacks,
...
{
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_TerminateSys__handle;
}
