...
#include "custom_interfaces/msg/detail/set_weigh_io__rosidl_typesupport_fastrtps_c.h"
...
using _SetWeighIO__ros_msg_type = custom_interfaces__msg__SetWeighIO;
...
{
  const _SetWeighIO__ros_msg_type * ros_message = static_cast<const _SetWeighIO__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces__msg__SetWeighIO;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const custom_interfaces__msg__SetWeighIO * ros_message = static_cast<const custom_interfaces__msg__SetWeighIO *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_custom_interfaces__msg__SetWeighIO(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  custom_interfaces__msg__SetWeighIO * ros_message = static_cast<custom_interfaces__msg__SetWeighIO *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_custom_interfaces__msg__SetWeighIO(cdr, ros_message);
}

static uint32_t _SetWeighIO__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces__msg__SetWeighIO(
...
static size_t _SetWeighIO__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interfaces__msg__SetWeighIO(
...
static message_type_support_callbacks_t __callbacks_SetWeighIO = {
...
static rosidl_message_type_support_t _SetWeighIO__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SetWeighIO,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, msg, SetWeighIO)() {
  return &_SetWeighIO__type_support;
}
