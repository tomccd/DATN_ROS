...
#include "custom_interfaces/msg/detail/terminate__type_support.h"
...
static const _Terminate_type_support_symbol_names_t _Terminate_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, msg, Terminate)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interfaces, msg, Terminate)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, custom_interfaces, msg, Terminate)() {
  return &::custom_interfaces::msg::rosidl_typesupport_c::Terminate_message_type_support_handle;
}
