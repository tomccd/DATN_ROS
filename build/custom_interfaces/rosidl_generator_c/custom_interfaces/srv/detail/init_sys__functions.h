...
#ifndef CUSTOM_INTERFACES__SRV__DETAIL__INIT_SYS__FUNCTIONS_H_
#define CUSTOM_INTERFACES__SRV__DETAIL__INIT_SYS__FUNCTIONS_H_
...
/// Initialize srv/InitSys message.
/**
 ...
 * )) before or use
 * custom_interfaces__srv__InitSys_Request__create()
...
/// Create srv/InitSys message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custom_interfaces__srv__InitSys_Request__init().
...
/// Destroy srv/InitSys message.
/**
 * It calls
 * custom_interfaces__srv__InitSys_Request__fini()
...
/// Check for srv/InitSys message equality.
/**
...
/// Initialize array of srv/InitSys messages.
/**
...
/// Finalize array of srv/InitSys messages.
/**
 * It calls
 * custom_interfaces__srv__InitSys_Request__fini()
...
/// Create array of srv/InitSys messages.
/**
 * It allocates the memory for the array and calls
 * custom_interfaces__srv__InitSys_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/InitSys messages.
/**
 * It calls
 * custom_interfaces__srv__InitSys_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/InitSys message array equality.
/**
...
/// Copy an array of srv/InitSys messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * custom_interfaces__srv__InitSys_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custom_interfaces__srv__InitSys_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interfaces
...
/**
 * It calls
 * custom_interfaces__srv__InitSys_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interfaces
...
/**
 * It allocates the memory for the array and calls
 * custom_interfaces__srv__InitSys_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interfaces
...
/**
 * It calls
 * custom_interfaces__srv__InitSys_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * custom_interfaces__srv__InitSys_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custom_interfaces__srv__InitSys_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interfaces
...
/**
 * It calls
 * custom_interfaces__srv__InitSys_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interfaces
...
/**
 * It allocates the memory for the array and calls
 * custom_interfaces__srv__InitSys_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interfaces
...
/**
 * It calls
 * custom_interfaces__srv__InitSys_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CUSTOM_INTERFACES__SRV__DETAIL__INIT_SYS__FUNCTIONS_H_
